...
{
	Solver solver{"4x4-simple-game.txt"};
	list<Board> solution = solver.solveAStar();
	list<Board> expected_solution = {
		Board({
			{0, 0, 0, 0},
